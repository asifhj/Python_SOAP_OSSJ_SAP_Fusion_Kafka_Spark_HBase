...
def drop_database():
    ...
    client.drop_database("SAPNotesEvent")

def upsert_record(coll, doc):
    client = MongoClient('10.219.48.134', 27017)
    db = client['SAPNotesEvent']
    collection = db[coll]
...
# To consume messages
consumer = KafkaConsumer('SAPNotesEvent', bootstrap_servers=['172.22.147.242:9092'], auto_commit_enable=False, auto_offset_reset="smallest")
